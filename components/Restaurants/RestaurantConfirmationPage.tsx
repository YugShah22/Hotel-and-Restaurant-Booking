  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="max-w-5xl w-full p-12 bg-white rounded-3xl shadow-2xl border border-gray-200 text-center space-y-8">
        <h2 className="text-4xl font-bold text-green-600">Reservation Confirmed!</h2>
        <p className="text-xl text-gray-700">
          Your table at <span className="font-semibold text-blue-600">{booking.restaurantName}</span> is confirmed.
        </p>
